module.exports = {
  ...
  connectToEthWallet: function () {
    ...
    $(".first-time-flow__button").waitForDisplayed({
      timeout: 20000,
      timeoutMsg: "Get started Button not displayed",
    });
    $(".first-time-flow__button").click();
    $("button=Import wallet").waitForDisplayed({
      timeout: 20000,
      timeoutMsg: "import wallet button not displayed",
    });
    ...
    $('[data-testid="popover-close"]').waitForDisplayed({
      timeout: 10000,
      timeoutMsg: "pop over close not display",
    });
    ...
    $(".network-display").waitForDisplayed({
      timeout: 10000,
      timeoutMsg: "Network-display Button not displayed",
    });
